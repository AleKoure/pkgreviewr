...
Use Mozilla review principles to focus on correctness and usability risks.
Use rOpenSci package guidance to focus on release-readiness risks in package metadata, docs, vignettes, and tests.
If there are no major blockers, say so explicitly and keep the section brief.
